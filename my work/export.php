...
{
$filename = '/var/www/html/my work/uploads/'.strtotime("now").'.csv';
...
if($num_rows >= 1)
{
	...
	fclose($fp);
	echo "Your file is ready. You can download it from <a href='/var/www/html/my works/uploads/$filename'>here!</a>";
}
else
{
