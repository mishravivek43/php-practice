 ...
 */
 class urlsize
 {
	 //curl function to determine url or link data
...
//for testing urlsizr.php
//creating class object
/*
$urlobject=new urlsize();
echo "for url google.com\n";
$contentLength=$urlobject->get_size("www.google.com");
$status=$urlobject->get_status("www.google.com");
$contentLength = $urlobject->human_filesize($contentLength,3);
echo 'HTTP Status: ' . $status . "\n";
echo 'Content-Length: ' . $contentLength. "\n";
echo "for csv file @ a location @ localhost\n";
$contentLength=$urlobject->get_size("localhost/login/uploads/1458275387.csv");
$status=$urlobject->get_status("localhost/login/uploads/1458275387.csv");
$contentLength = $urlobject->human_filesize($contentLength,3);
echo 'HTTP Status: ' . $status . "\n";
echo 'Content-Length: ' . $contentLength. "\n";
*/
